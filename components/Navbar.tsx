...
export default function Navbar() {
    ...
    console.log(menu)
  return (
    <nav className='max-w-7xl flex mx-auto justify-between max-sm:w-full max-sm:justify-between sm:items-center my-4 border rounded-2xl px-10 py-4'>
        <h1 className='w-1/2 max-sm:w-fit capitalize font-bold text-xl tracking-wide cursor-pointer'>bain<span className='bg-bainiac rounded-md px-2 py-1.5 text-white'>iac</span></h1>
        ...
        <div className={`w-full flex flex-col sm:hidden items-center mt-10 justify-center ease-in-out duration-500 max-h-0 overflow-clip ${menu ? "max-sm:min-h-[40vh] max-w-full" : "max-sm:min-h-0"}`}>
